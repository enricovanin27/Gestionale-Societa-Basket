                    ...
                    righe.map(r => {
                      ...
                      return (
                        <div key={r.id} className={`rounded-lg bg-white border border-l-4 border-gray-100 ${col.border} p-2 mb-1.5 shadow-sm`}>
                          ...
                          {r.prep_inclusa && (
                            <div className="mt-1">
                              <span className="inline-block text-[9px] font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-1.5 py-0.5 rounded-full">
                                ⚡ {r.prep_quando} · {r.prep_durata_min}min{r.prep_su_campo ? ' · campo' : ''}
                              </span>
                            </div>
                          )}
                          {canEditRow(r) && (
