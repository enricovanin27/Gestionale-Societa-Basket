...
export default function PagamentoModal({ quota, giocatore, societaId, onClose }) {
  ...
  const confirmMut = useMutation({
    mutationFn: async () => {
      ...
      if (isParziale) {
        // Pagamento parziale: aggiorna importo al versato e segna come pagata
        ...
        // Pagamento totale: comportamento standard
            ...
            <>
              ...
              <div className="flex gap-2">
                ...
                <button type="button"
                  ...
                  disabled={confirmMut.isPending || !dataPagamento || versato <= 0 || versato > quota.importo}
